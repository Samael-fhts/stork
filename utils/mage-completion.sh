...
# This script provide tab completion for mage commands.
# It is heavily based on this script:
# Source: https://github.com/magefile/mage/issues/113#issuecomment-437710124
#
# Usage: source ./mage-completion.sh
#
# Then type mage and press tab to get completion.
