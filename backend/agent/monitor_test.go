...
func TestDetectPowerDNSDaemonAbsPath(t *testing.T) {
...
// Check PowerDNS daemon detection when its conf file is relative to CWD of its process.
func TestDetectPowerDNSDaemonRelativePath(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
