...
//go:generate go tool go.uber.org/mock/mockgen -source hook_test.go -package=agent -destination=hookmock_test.go -mock_names=beforeForwardToKeaOverHTTPCalloutCarrier=MockBeforeForwardToKeaOverHTTPCalloutCarrier isc.org/agent beforeForwardToKeaOverHTTPCalloutCarrier
