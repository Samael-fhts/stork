...
func GenerateKeaV4Config(n int) map[string]any {
	inner := 0
	outer := 0
	if n/256 > 0 {
		inner = 255
...
func generateV4Subnet(rangeOfOuterScope int, rangeOfInnerScope int) any {
	var subnets []any
	netmask := 8
	...
	optionData4 := []any{
		map[string]any{"code": 2, "data": "50", "name": "time-offset", "space": "dhcp4"},
		map[string]any{"code": 3, "data": "100.100.100.10,50.50.50.5", "name": "routers", "space": "dhcp4"},
		map[string]any{"code": 4, "data": "199.199.199.1,199.199.199.2", "name": "time-servers", "space": "dhcp4"},
		map[string]any{"code": 5, "data": "199.199.199.1,100.100.100.1", "name": "name-servers", "space": "dhcp4"},
		map[string]any{"code": 6, "data": "199.199.199.1,100.100.100.1", "name": "domain-name-servers", "space": "dhcp4"},
		map[string]any{"code": 7, "data": "199.199.199.1,100.100.100.1", "name": "log-servers", "space": "dhcp4"},
		map[string]any{"code": 76, "data": "199.1.1.1,200.1.1.2", "name": "streettalk-directory-assistance-server", "space": "dhcp4"},
		map[string]any{"code": 19, "csv-format": true, "data": "True", "name": "ip-forwarding", "space": "dhcp4"},
		map[string]any{"code": 20, "data": "True", "name": "non-local-source-routing", "space": "dhcp4"},
		map[string]any{"code": 29, "data": "False", "name": "perform-mask-discovery", "space": "dhcp4"},
	}
