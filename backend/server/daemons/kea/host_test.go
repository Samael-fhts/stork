...
func TestDetectHostsFromConfig(t *testing.T) {
	...
	_ = daemon1.SetKeaConfigFromJSON(getTestConfigWithIPv4GlobalHosts())
	...
	_ = daemon2.SetKeaConfigFromJSON(getTestConfigWithIPv6GlobalHosts())
...
func TestGetPageFromHostCmds(t *testing.T) {
	...
	err = daemon1.SetKeaConfigFromJSON(getTestConfigWithIPv4Subnets(true))
	require.NoError(t, err)
	...
	err = daemon2.SetKeaConfigFromJSON(getTestConfigWithIPv6Subnets())
	require.NoError(t, err)
	...
	require.Zero(t, (fa.GetLastCommandArguments()["subnet-id"]))
	require.NotContains(t, fa.GetLastCommandArguments(), "from")
	require.Contains(t, fa.GetLastCommandArguments(), "source-index")
	...
	testReservationGetPageReceived(t, it)
	require.Zero(t, fa.GetLastCommandArguments()["subnet-id"])
	require.Contains(t, fa.GetLastCommandArguments(), "from")
	require.Contains(t, fa.GetLastCommandArguments(), "source-index")
	...
	testReservationGetPageReceived(t, it)
	require.EqualValues(t, 234, fa.GetLastCommandArguments()["subnet-id"])
	require.NotContains(t, fa.GetLastCommandArguments(), "from")
	require.Contains(t, fa.GetLastCommandArguments(), "source-index")
	...
	testReservationGetPageReceived(t, it)
	require.EqualValues(t, 345, fa.GetLastCommandArguments()["subnet-id"])
	require.NotContains(t, fa.GetLastCommandArguments(), "from")
	require.Contains(t, fa.GetLastCommandArguments(), "source-index")
	...
	testReservationGetPageReceived(t, it)
	require.EqualValues(t, 567, fa.GetLastCommandArguments()["subnet-id"])
	require.NotContains(t, fa.GetLastCommandArguments(), "from")
	require.Contains(t, fa.GetLastCommandArguments(), "source-index")
	...
	testReservationGetPageReceived(t, it)
	require.EqualValues(t, 678, fa.GetLastCommandArguments()["subnet-id"])
	require.NotContains(t, fa.GetLastCommandArguments(), "from")
	require.Contains(t, fa.GetLastCommandArguments(), "source-index")
...
func TestFetchHostsFromHostCmds(t *testing.T) {
	...
	_ = daemon1.SetKeaConfigFromJSON(getTestConfigWithIPv4Subnets(true))
	...
	_ = daemon2.SetKeaConfigFromJSON(getTestConfigWithIPv6Subnets())
...
func TestReduceHostsIntoDB(t *testing.T) {
	...
	_ = daemon.SetKeaConfigFromJSON(getTestConfigWithOneIPv4Subnet())
...
func TestSkipPullingHostsIntoDB(t *testing.T) {
	...
	_ = daemon1.SetKeaConfigFromJSON(getTestConfigWithIPv4Subnets(false))
...
func TestUpdateHost(t *testing.T) {
	...
	_ = daemon.SetKeaConfigFromJSON(getTestConfigWithOneIPv6Subnet())
