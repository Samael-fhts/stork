...
//go:generate go tool go.uber.org/mock/mockgen -package=hookmanager -destination=authenticationcalloutcarriermock_test.go -source=authentication_test.go -mock_names=authenticationCalloutCarrier=MockAuthenticationCalloutCarrier isc.org/server/hookmanager authenticationCalloutCarrier
//go:generate go tool go.uber.org/mock/mockgen -package=hookmanager -destination=authenticationcalloutsmock_test.go -source=../../hooks/server/authenticationcallouts/authenticationcallouts.go isc.org/server/hookmanager AuthenticationMetadata
