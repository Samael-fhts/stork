...
# Files that must be non-world-writable.
radius_files = FileList["tests/system/config/radius/*"]
radius_files.each do |path|
    non_world_writable_file path
end
volume_files.append *radius_files
