...
kea_many_host_reservations_dir = "tests/system/config/kea-many-host-reservations"
directory kea_many_host_reservations_dir
autogenerated.append kea_many_host_reservations_dir

gen_kea_config_script = "docker/tools/gen_kea_config.py"

kea_many_subnets_config_file = File.join(kea_many_subnets_dir, "kea-dhcp4.conf")
file kea_many_subnets_config_file => [PYTHON, gen_kea_config_script, kea_many_subnets_dir] do
    sh PYTHON, gen_kea_config_script, "7000",
...
file kea_many_subnets_and_shared_networks_config_file => [PYTHON, gen_kea_config_script, kea_many_subnets_dir] do
    sh PYTHON, gen_kea_config_script, "-n", "4400", "13000",
...
kea_many_host_reservations_config_file = File.join(kea_many_host_reservations_dir, "kea-dhcp4-s40-h250-1.conf")
file kea_many_host_reservations_config_file => [PYTHON, gen_kea_config_script, kea_many_host_reservations_dir] do
    stdout, stderr, status = Open3.capture3 PYTHON, gen_kea_config_script,
        "--add-includes",
        "-r", "250",
        "40",
        "-o", kea_many_host_reservations_config_file,
        "--interface", "eth1"
    if status != 0
        puts stdout, stderr, status
        fail
...
autogenerated.append kea_many_host_reservations_config_file
volume_files.append kea_many_host_reservations_config_file

kea_many_host_reservations_config_file_copy = File.join(kea_many_host_reservations_dir, "kea-dhcp4-s40-h250-2.conf")
file kea_many_host_reservations_config_file_copy => [kea_many_host_reservations_config_file] do
    FileUtils.cp kea_many_host_reservations_config_file, kea_many_host_reservations_config_file_copy
end
autogenerated.append kea_many_host_reservations_config_file_copy
volume_files.append kea_many_host_reservations_config_file_copy
