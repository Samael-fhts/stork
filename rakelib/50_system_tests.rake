...
file kea_many_host_reservations_config_file => [PYTHON, kea_many_host_reservations_dir] do
    stdout, stderr, status = Open3.capture3 PYTHON, "docker/tools/gen_kea_config.py",
        "--add-includes",
        "-r", "250",
        "40",
