...
class MockDHCPService implements Partial<DHCPService> {
    getHosts(start?: number, limit?: number, appId?: number, subnetId?: number, localSubnetId?: number, text?: string, global?: boolean, conflict?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json',}): Observable<any> {
        return of({
            total: 1,
            items: [
                {
