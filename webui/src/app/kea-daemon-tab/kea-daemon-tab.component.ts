...
@Component({
    selector: 'app-kea-daemon-tab',
    standalone: false,
    templateUrl: './kea-daemon-tab.component.html',
    styleUrls: ['./kea-daemon-tab.component.sass'],
})
export class KeaDaemonTabComponent {
     ...
     */
    get daemonStatusIconName(): string {
